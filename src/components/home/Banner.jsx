    ...
    return (
        <div className=' h-full w-full '>
            ...
            <div className=' absolute w-full h-full top-16  flex flex-col justify-center items-center'>
                ...
                <p className=' text-white text-center sm:w-2/4  '>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam fugit voluptas optio accusantium suscipit</p>
                <div className=" mt-10">
